...
export class ResourceService {
  ...
  getResourceList(pagination: any, filters: any, sortOptions: any, pageStatus: string = 'drafts', status: string = ''): Observable<any> {
    const endpoint = RESOURCE_URLS.RESOURCE_LIST;
    const params = this.commonService.generateParams(pagination, filters, sortOptions, pageStatus, status);
